...
<template>
    <div class="flex flex-col space-y-10 items-center justify-start w-full h-screen bg-slate-400">
        ...
        <h1 class="text-4xl font-bold pt-14 text-white">Ini Halaman Sign up</h1>

        <!-- Login Card -->
        <div class="flex flex-col px-8 py-8 bg-white items-center space-y-8">
            <h2 class="text-2xl font-bold">Sign Up</h2>
            <div class="flex flex-col space-y-4">
                <div class="flex flex-col">
                    <span v-show="currentFocus === placeholderMap[0]" class="text-slate-400 text-sm">Name</span>
                    <input v-model="name" @focus="changeFocus(placeholderMap[0])" type="text"
                ...
                <div class="flex flex-col">
                    ...
                    <input v-model="email" @focus="changeFocus(placeholderMap[1])" type="email"
