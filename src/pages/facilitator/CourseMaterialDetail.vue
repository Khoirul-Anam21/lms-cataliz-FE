...
import TheMaterialDescription from '../../components/course/TheMaterialDescription.vue';
...
const descBtn: Ref<HTMLButtonElement | null> = ref(null);


onMounted(async () => {
  await nextTick()
  currentTab.value = 'desc';
})
...
<template>
  <div class="mt-20 md:mt-28 md:ml-64 mb-20">
    ...
    <div
      class="ml-5 mt-10 text-sm font-medium text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700 w-11/12">
      <TabBarView>
