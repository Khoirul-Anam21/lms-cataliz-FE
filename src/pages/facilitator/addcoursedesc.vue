...
<template>
  <div>
    <div class="mt-20 md:mt-28 md:ml-64 mb-20">
      ...
      <div class="mt-10 ml-5">
        <!-- you can wrap it with form -->
      <CourseInput/>

      <router-link :to="{ name: 'material-add' }">
        <button type="button"
          class="text-white mt-10 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 ml-50 ">Add</button>
      </router-link>
